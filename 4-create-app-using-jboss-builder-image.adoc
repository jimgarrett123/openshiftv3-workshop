...
|=========================================================
|Name |Git Repository URL | Git Reference | Context Directory
|ks   |https://github.com/RedHatWorkshops/kitchensink | master | .
|=========================================================
...
----
$ curl http://ks-<your_project_name>.apps.rhpds.openshift.opentlc.com/
...
Then from the Browser locate the Provisioned Service (in the project) named JBoss EAP 7.0, then click its menu (to the right) and select 'Delete'
