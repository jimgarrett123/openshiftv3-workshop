...
* Lab 13. link:17_Dynamic_Configuration_Updates_using_ConfigMap.adoc[Dynamic Configuration updates using ConfigMap]
* Lab 14. link:18_Changing_code_on_the_fly.adoc[Changing code on the fly]
* Lab 15. link:19_Creating_a_Pipeline.adoc[Creating a CI/CD Pipeline]
* Lab 16. link:21-dotnet-and-mysql-using-template.adoc[Dot Net and PostgreSql using a Template]